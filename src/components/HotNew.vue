...
<template>
 <div   class="bg-white dark:bg-neutral-900 dark:text-neutral-200 ">
    ...
    <div  class= "flex flex-row justify-between mx-auto max-w-2xl overflow-hidden    lg:max-w-7xl "> 
        <h2 class=" text-2xl  pt-16 font-bold tracking-tight mb-8 text-sky-400 cursor-textr">Гарячі новинки</h2>
          <div class="   pt-16 ">
            <a href="#" class="text-blue-300 text-bold border-b-2 border-white hover:border-sky-500  w-20 h-10  rounded text-center text-sm font-medium">Закладки</a>
          </div>
